...
import { VariableChipComponent, VariableObject } from "../../shared-variables/drawing/variable-object";
...
export type DrawingObjectSnapshotUnion = 
  ...
  SnapshotIn<typeof VariableObject>;
...
export const DrawingObjectMSTUnion = 
  types.union(LineObject, VectorObject, RectangleObject, EllipseObject, ImageObject, VariableObject);
