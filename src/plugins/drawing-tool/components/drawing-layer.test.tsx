...
describe("Drawing Layer Components", () => {
  describe("Freehand Line", () => {
    ...
    it("adds a freehand line", () => {
      // FIXME: These tests are now more about testing the migration code to make sure 
      // the rended svg matches what it used to be.  So maybe they should be copied
      // into a new test file and this current file should work with the direct object
      // instead of the changes. We should try to copy the snapshots to.
