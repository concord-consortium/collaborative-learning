...
import { defaultSimulatorContent } from "./simulator-content";
import { SimulatorToolComponent } from "./simulator-tile";

// The Simulator tile needs to be registered so the TileModel.create
// knows it is a supported tile type
import "./simulator-registration";

describe("SimulatorToolComponent", () => {
  ...
  it("renders successfully", () => {
    const {getByText} =
      render(<SimulatorToolComponent  {...defaultProps} {...{model}}></SimulatorToolComponent>);
