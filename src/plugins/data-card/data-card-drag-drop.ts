...
// //based on image-drag-drop.ts
// export class DataCardDragDrop {
...
//     console.log("📁 data-card-drag-drop.ts > 🔨dragOver");
...
//     console.log("📁 data-card-drag-drop.ts > 🔨 checkForAcceptableImageDrag ");
//     const acceptableByClient = !this.options.isAcceptableImageDrag || this.options.isAcceptableImageDrag(e);
//     const returnArg = (this.hasUriList(e) || this.hasFileList(e)) && acceptableByClient;
//     console.log("🔨 returns:", returnArg);
//     return returnArg;
