...
export const kVariableChipDataType = "m2s-variable";
export const kVariableChipDataTypeAttr = "data-slate-type";
...
export const VariableComponent = observer(function({ attributes, children, element }: RenderElementProps) {
  ...
  if (isSerializing) {
    const serializeAttrs = {
      [kVariableChipDataTypeAttr]: kVariableChipDataType,
...
export function registerVariables() {
  ...
  registerElementDeserializer("span", {
    test: (el: HTMLElement) => el.getAttribute(kVariableChipDataTypeAttr) === kVariableChipDataType,
