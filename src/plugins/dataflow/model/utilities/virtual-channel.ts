...
const virtualTempChannel: NodeChannelInfo = {
  hubName: "Virtual Sensor", name: "Temperature", channelId: "00001-VIR",
...
const virtualHumidChannel: NodeChannelInfo = {
  hubName: "Virtual Sensor", name: "Humidity", channelId: "00002-VIR",
...
const virtualCO2Channel: NodeChannelInfo = {
  hubName: "Virtual Sensor", name: "CO2", channelId: "00003-VIR",
...
//   hubName: "Virtual Sensor", name: "O2", channelId: "00004-VIR",
...
//   hubName: "Virtual Sensor", name: "Light", channelId: "00005-VIR",
...
const virtualPartChannel: NodeChannelInfo = {
  hubName: "Virtual Sensor", name: "Particulates", channelId: "00006VIR",
