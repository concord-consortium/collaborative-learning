...
export class ConfigurationManager implements UnitConfiguration {
  ...
  get chatTutorProvider(){
    return this.getProp<UC["chatTutorProvider"]>("chatTutorProvider");
  }
  ...
  get chatTutorHighlights(){
    return this.getProp<UC["chatTutorHighlights"]>("chatTutorHighlights");
  }
  ...
  get classWideDocuments() {
    return this.getProp<UC["classWideDocuments"]>("classWideDocuments");
  }

  get aiUnitSummary() {
    return this.getProp<UC["aiUnitSummary"]>("aiUnitSummary");
  }
