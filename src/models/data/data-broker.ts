...
import { SharedDataSetType, SharedDataSet } from "../shared/shared-data-set";
...
export class DataBroker {
  ...
  @action
  addDataAndMetadata(data: SharedDataSetType, metadata: ISharedCaseMetadata) {
  ...
  @action
  addSharedDataSet(shared: SharedDataSetType) {
