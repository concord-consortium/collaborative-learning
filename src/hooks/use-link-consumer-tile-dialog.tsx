...
const Content: React.FC<IContentProps>
              = ({ linkedTiles, selectValue, tileTitle, tileType, unlinkedTiles, setSelectValue })=> {
...
export const useLinkConsumerTileDialog = ({ linkableTiles, model, tileType,
    onLinkTile, onUnlinkTile, onCreateTile }: IProps) => {
