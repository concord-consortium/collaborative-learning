...
describe("ToolButtonComponent", () => {
  ...
  it("activates visual state on Enter keydown and deactivates on keyup", () => {
    const toolButton = ToolbarButtonModel.create({
      id: "select",
      title: "Select",
      iconId: "icon-select-tool",
    ...
    expect(onSetToolActive).toHaveBeenCalledWith(toolButton, true);

    fireEvent.keyUp(button, { key: "Enter" });
    expect(onSetToolActive).toHaveBeenCalledWith(toolButton, false);
  });

  it("activates visual state on Space keydown and deactivates on keyup", () => {
    const toolButton = ToolbarButtonModel.create({
      id: "select",
      title: "Select",
      iconId: "icon-select-tool",
  ...
  it("does not activate visual state on keyboard when disabled", () => {
    const toolButton = ToolbarButtonModel.create({
      id: "select",
      title: "Select",
      iconId: "icon-select-tool",
