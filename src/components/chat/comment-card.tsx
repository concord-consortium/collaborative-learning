...
interface ICommentItemProps {
  ...
  onCommentClick?: (commentId: string) => void;
  renderRatingButtons: (comment: WithId<CommentDocument>) => JSX.Element | null;
}
...
const CommentItem: React.FC<ICommentItemProps> = ({
  ...
  onDeleteComment, onOpenLinkedDocument, onCommentClick, renderRatingButtons
}) => {
          ...
          postedComments?.map((comment, idx) => {
            ...
            return (
              ...
              <CommentItem
                ...
                renderRatingButtons={renderRatingButtons}
              />
            );
          })
        }
