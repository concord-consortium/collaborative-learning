...
import { EContentTabOrder, ContentTabSectionModelType } from "../../models/view/content-tabs";
...
interface IProps {
  tab: string;
  section: ContentTabSectionModelType;
  stores: IStores;
  scale: number;
  onNewDocumentClick?: (section: ContentTabSectionModelType) => void;
...
function getDocumentCaption(section: ContentTabSectionModelType, stores: IStores, document: DocumentModelType) {
...
export const TabPanelDocumentsSection = observer(({ tab, section, stores, scale,
    ...
    if (section.order === EContentTabOrder.kReverse) {
