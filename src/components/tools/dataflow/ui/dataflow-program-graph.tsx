...
import { ChartPlotColors } from "../../../../models/tools/dataflow/utilities/node";
import { exportDataCSV } from "../../../../models/tools/dataflow/utilities/export";
...
export class DataflowProgramGraph extends React.Component<IProps, IState> {
  ...
  private setDataSetHiddenState(i: number, hidden: boolean) {
    this.setState(prevState => {
      const dataSetHidden = prevState.dataSetHidden.slice();
