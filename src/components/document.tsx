...
export class DocumentComponent extends BaseComponent<IProps, {}> {
  ...
  private renderShare() {
    ...
    return (
      <div key="share" className={`visibility action ${currVis}`}>
        <svg id="currVis" className={`share icon icon-share`} data-test="share-icon" onClick={this.handleToggleVisibility}>
    ...
    return (
      <div className="learning-log titlebar">
        <div className="actions">
          {!hideButtons &&
            <div className="actions">
              <svg key="publish" className={`icon icon-publish`} data-test="learning-log-publish-icon" onClick={this.handlePublishLearningLog}>
                <use xlinkHref={`#icon-publish`} />
              </svg>
            </div>
          }
  ...
  private renderTwoUpButton() {
    ...
    return (
      <div className="mode action">
        <svg id="currMode" className={`mode icon icon-${currMode}`} data-test="two-up-curr-mode" onClick={this.handleToggleTwoUp}>
          <use xlinkHref={`#icon-${currMode}`} />
        </svg>
