...
- `TreeManager`(MST): This contains a CDocument and a UndoStore. It also tracks the set of trees. It implements the TreeManagerAPI.
...
- `addTreeMonitor`: a MST middleware which records the actions.
