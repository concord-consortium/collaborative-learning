...
context('canvas test',()=>{
    ...
    describe('verify run program toolbar functionality', ()=>{
        ...
        it('verify program toolbar is not visible after program run',()=>{
            dfcanvas.runProgram();
            cy.wait(1500);
    ...
    describe('test save and restore',()=>{
        ...
        before(function(){//start clean
            let num1=4, num2=5, operator='multiply',storeName='multiplied',seqName='multiplication';
            ...
            canvas.getPersonalDocTitle().invoke('text').as('title')
        })
        it.skip('verify program is restored when reopened',function () { //Waiting for data-test attribute updates
            ...
            //TODO :waiting on data-test attribute updates from Avi
            // rightNav.openSection('my-work','Programs');
            // rightNav.openCanvasItem('my-work','Programs',this.title)
            cy.wait(5000)
            ...
            dfblock.getMathValueTextField().invoke('text').should('eq',mathValue)
