...
function beforeTest() {
  const queryParams = "/?appMode=demo&demoName=CLUE-Test&fakeClass=1&problem=1.1&fakeUser=teacher:1&unit=example-config-subtabs&curriculumBranch=sort-tab-dev-3&noPersistentUI";
  cy.clearQAData('all');
