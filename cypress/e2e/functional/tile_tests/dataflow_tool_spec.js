...
context('Dataflow Tool Tile', function () {
  ...
  it("Sensor Node and Record Data", () => {
    ...
    const sensorSelect = [
      ...
      "⚠️ Connect a device for live EMG",
      "⚠️ Connect a device for live Pressure",
      "⚠️ Connect a device for live Temperature",
      "⚠️ Connect a device for live A1",
      "⚠️ Connect a device for live Temperature A",
      "⚠️ Connect a device for live Humidity A",
      "⚠️ Connect a device for live Temperature B",
      "⚠️ Connect a device for live Humidity B",
      "⚠️ Connect a device for live Temperature C",
      "⚠️ Connect a device for live Humidity C",
      "⚠️ Connect a device for live Temperature D",
      "⚠️ Connect a device for live Humidity D",
    ];
    dataflowToolTile.getCreateNodeButton(sensorNode).click();
